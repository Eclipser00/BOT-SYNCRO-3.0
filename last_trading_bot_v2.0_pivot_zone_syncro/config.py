...
1) Cambia ACTIVE_ENV a "development" o "production".
...
class BotConfig:
    ...
    mode: str  # modo de ejecucion (production/development)
...
ENVIRONMENTS: Dict[str, BotConfig] = {
    ...
    "development": BotConfig(
        ...
        logging=LoggingConfig(
            ...
            pivot_log_file_path="logs/pivot_zones.log",  # log dedicado de zonas pivote
            visualizer_start_from_end=False,  # False para depurar con historial completo en cada arranque
        ),
        risk=RiskConfig(
